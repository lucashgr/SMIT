...
def principal():
    ...
    #----------------------------------Tempo------------------------------#
    label_tempo = tk.Label(frame_entradas, text="\n\nVariáveis da Simulação", font=("Segoe UI", 12, "bold"))
    ...
    label_dt = tk.Label(frame_entradas, text="Frequência de amostragem (Hz):")
    ...
    def dt_message(event):
        ...
        message = tk.Label(popup,
                           text="Frequência que define o intervalo de tempo entre iterações", wraplength=400)
    ...
    label_tt = tk.Label(frame_entradas, text="Tempo de simulação (s):")
    ...
    def tt_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Tempo total simulado (Valores grandes podem deixar a simulação mais demorada", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_V = tk.Label(frame_entradas, text="Tensão eficaz de linha (V):")
    ...
    def V_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Tensão nominal, de linha, que alimenta o motor", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_f = tk.Label(frame_entradas, text="Frequência da alimentação:")
    ...
    def f_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Frequência do sinal de alimentação da máquina", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    #----------------------------------Dados Nominais------------------------------#
    label_tempo = tk.Label(frame_entradas, text="Dados Nominais da Máquina", font=("Segoe UI", 12, "bold"))
    label_tempo.grid(row=4, columnspan=8, sticky=tk.W)

    label_P = tk.Label(frame_entradas, text="Número de Polos:")
    ...
    label_vnom = tk.Label(frame_entradas, text="Velocidade nominal (RPM):")
    ...
    def vnom_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Velocidade alcançada pelo motor em condições nominais de funcionamento", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_Tload = tk.Label(frame_entradas, text="Carga nominal (Nm):")
    ...
    def Tload_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Carga suportada pela máquina em condições nominais", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_j = tk.Label(frame_entradas, text="Momento de inércia (kgm²):")
    ...
    def j_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Momento de inércia do motor, equivalente ao grau de dificuldade para acelerar a máquina", wraplength=300)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_In = tk.Label(frame_entradas, text="Corrente eficaz de linha (A):")
    ...
    def In_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Corrente nominal, de linha, que alimenta o motor",
                           wraplength=300)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_tempo = tk.Label(frame_entradas, text="Parâmetros do Circuito (Y)", font=("Segoe UI", 12, "bold"))
    label_tempo.grid(row=10, columnspan=8, sticky=tk.W)

    label_rs = tk.Label(frame_entradas, text="Resistência do estator (ohms):")
    ...
    def rs_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Resistência do estator, do circuito equivalente", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_rr = tk.Label(frame_entradas, text="Resistência do rotor (ohms):")
    ...
    def rr_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Resistência do rotor, do circuito equivalente", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_xs = tk.Label(frame_entradas, text="Reatância do estator (ohms):")
    ...
    def xs_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Reatância de disperção do estator, do circuito equivalente", wraplength=300)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_xm = tk.Label(frame_entradas, text="Reatância mútua (ohms):")
    ...
    def xm_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Reatância mútua da máquina, do circuito equivalente", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_xr = tk.Label(frame_entradas, text="Reatância do rotor (ohms):")
    ...
    def xr_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Reatância de disperção do rotor, do circuito equivalente", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    #----------------------------------Carga------------------------------#
    label_cargaconfig = tk.Label(frame_entradas, text="Configurações de Carga", font=("Segoe UI", 12,"bold"))
    label_cargaconfig.grid(row=13, columnspan=8, sticky=tk.W)

    label_part = tk.Label(frame_entradas, text="Tipo de Partida:")
    ...
    def part_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Selecionar se a partida do motor será feita com ou sem carga", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    options_part = ["Sem Carga", "Com Carga"]
    ...
    label_carga = tk.Label(frame_entradas, text="Tipo de Carga:", state='disabled')
    ...
    def carga_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Selecionar o tipo de carga aplicada na partida", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    options_carga = ["Constante", "Linear", "Quadrática"]
    ...
    label_tp = tk.Label(frame_entradas, text="Tempo de partida (s):")
    ...
    def tp_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Tempo de partida do motor, onde não serão aplicadas cargas ou falhas", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_pcarga = tk.Label(frame_entradas, text="Carga aplicada (%):")
    ...
    def pcarga_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Porcentagem de carga aplicada, em relação à nominal", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_jload = tk.Label(frame_entradas, text="Momento de inércia (kgm²):")
    ...
    def jload_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Momento de inércia da carga, equivalente ao grau de dificuldade para acelerar a carga", wraplength=300)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    box_des = tk.Checkbutton(frame_entradas, text="Desequilíbrio de Tensão", font=("Segoe UI", 12,"bold"), variable=estado_des)
    ...
    label_desamp = tk.Label(frame_entradas, text="Percentual de desequilíbrio (%):")
    ...
    def desamp_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Este valor será multiplicado pela amplitude da tensão de alimentação da fase a", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_desang = tk.Label(frame_entradas, text="Desequilíbrio angular (º):")
    ...
    def desang_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Valor, em graus, que será adicionado à defasagem da fase a (recomenda-se entre -30º a 30º)", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    box_curto = tk.Checkbutton(frame_entradas, text="Curto Circuito nas Espiras do Estator", font=("Segoe UI", 12,"bold"),
    ...
    label_mi = tk.Label(frame_entradas, text="Relação de espiras em curto (%):")
    ...
    def mi_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Razão entre a quantidade de espiras em curto e o total (recomenda-se um valor entre 0 e 5%)", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_rf = tk.Label(frame_entradas, text="Multiplicador:")
    ...
    def rf_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Esta variável impacta diretamente na amplitude da corrente de falha do motor, seu valor equivale a relação entre a corrente de curto e a corrente nominal da máquina", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    box_barra = tk.Checkbutton(frame_entradas, text="Barras Quebradas do Rotor", font=("Segoe UI", 12,"bold"),
    ...
    label_n = tk.Label(frame_entradas, text="Número de barras total:")
    ...
    def n_message(event):
        ...
        y = j1.winfo_pointery()
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup, text="Quantidade de barras total presentes na construção do rotor", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_nbq = tk.Label(frame_entradas, text="Número de barras quebradas:")
    ...
    def nbq_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Quantidade de barras quebradas no rotor (recomenda-se no máximo 3 barras, sendo que este valor nunca pode superar o valor total de barras, já que ocorre uma falha no código)", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    label_nivelbq = tk.Label(frame_entradas, text="Nível da falha:")
    ...
    def nivelbq_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="Indica o nível da falha, sendo o número entre parênteses a porcentagem de redução da corrente na barra", wraplength=300)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    options_nivelbq = ["Trinca (10%)", "Rachadura (50%)", "Quebra (100%)"]
    ...
    box_mec = tk.Checkbutton(frame_entradas, text="Falhas Mecânicas", font=("Segoe UI", 12,"bold"), variable=estado_mec)
    ...
    label_Tfalha = tk.Label(frame_entradas, text="Conjugado da falha (%):")
    ...
    def Tfalha_message(event):
        ...
        popup.geometry(f"+{x}+{y}")
        message = tk.Label(popup,
                           text="As falhas mecânicas são simuladas somando um torque variável ao conjugado de carga, o módulo deste torque é obtido a partir de uma porcentagem do torque nominal", wraplength=400)
        message.place(relx=0, rely=0)
        message.pack()
    ...
    def validar():
        ...
        try:
            ...
            if valor<1000:
                ...
                adicionar_mensagem("Frequência de amostragem menor que o mínimo aceitado: 1000 Hz")
                a+=1
        except ValueError:
            entry_dt.config(bg="red")
            adicionar_mensagem(label_dt.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_tt.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_tt.config(bg="red")
            adicionar_mensagem(label_tt.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_P.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_P.config(bg="red")
            adicionar_mensagem(label_P.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_V.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_V.config(bg="red")
            adicionar_mensagem(label_V.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_In.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_In.config(bg="red")
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_vnom.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_vnom.config(bg="red")
            adicionar_mensagem(label_vnom.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_Tload.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_Tload.config(bg="red")
            adicionar_mensagem(label_Tload.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_rs.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_rs.config(bg="red")
            adicionar_mensagem(label_rs.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_xs.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_xs.config(bg="red")
            adicionar_mensagem(label_xs.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_xm.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_xm.config(bg="red")
            adicionar_mensagem(label_xm.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_xr.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_xr.config(bg="red")
            adicionar_mensagem(label_xr.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_rr.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_rr.config(bg="red")
            adicionar_mensagem(label_rr.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        if entry_part.get()==options_part[0]:
            try:
                ...
                if valor >= float(entry_tt.get()):
                    ...
                    adicionar_mensagem(
                        "Como o tempo de partida é igual ou maior ao tempo total de simulação, a carga e falhas não serão aplicadas")
                    b += 1
                if valor<0:
                    entry_tp.delete(0, tk.END)
                    entry_tp.insert(0, 0)
                    entry_tp.config(bg="yellow")
                    adicionar_mensagem("Tempo de partida negativo alterado para zero")
                    b += 1
            except ValueError:
                entry_tp.config(bg="red")
                adicionar_mensagem(label_tp.cget("text") + " ENTRADA INVALIDA!")
                a += 1
        ...
        try:
            ...
            if not 0 <= valor <= 110:
                ...
                adicionar_mensagem(label_pcarga.cget("text") + " entrada fora do intervalo permitido (entre 0 e 110%)")
                a += 1
        except ValueError:
            entry_pcarga.config(bg="red")
            adicionar_mensagem(label_pcarga.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<0:
                ...
                adicionar_mensagem(label_jload.cget("text") + "Variável não pode negativa")
                a += 1
        except ValueError:
            entry_jload.config(bg="red")
            adicionar_mensagem(label_jload.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        try:
            ...
            if valor<=0:
                ...
                adicionar_mensagem(label_f.cget("text") + "Variável não pode ser nula ou negativa")
                a += 1
        except ValueError:
            entry_f.config(bg="red")
            adicionar_mensagem(label_f.cget("text") + " ENTRADA INVALIDA!")
            a += 1
        ...
        if estado_des.get():
            try:
                ...
                if valor <= 0:
                    ...
                    adicionar_mensagem(label_desamp.cget("text") + " Variável não pode ser nula ou negativa")
                    a+=1
                if 90 > valor > 110:
                    entry_desamp.config(bg="red")
                    adicionar_mensagem(label_desamp.cget("text") + " Variável fora do limite (±10%)")
                    a+=1
            except ValueError:
                entry_desamp.config(bg="red")
                adicionar_mensagem(label_desamp.cget("text") + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if -30 > valor > 30:
                    ...
                    adicionar_mensagem(label_desang.cget("text") + " Variável fora do limite (±30º)")
                    a += 1
            except ValueError:
                entry_desang.config(bg="red")
                adicionar_mensagem(label_desang.cget("text") + " ENTRADA INVALIDA!")
                a += 1
        ...
        if estado_curto.get():
            try:
                ...
                if not 0 <= valor <= 100:
                    ...
                    adicionar_mensagem(label_mi.cget("text") + " entrada fora do intervalo permitido (entre 0 e 100%)")
                    a += 1
            except ValueError:
                entry_mi.config(bg="red")
                adicionar_mensagem(label_mi.cget("text") + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                entry_rf.config(bg="red")
                adicionar_mensagem(label_rf.cget("text") + " ENTRADA INVALIDA!")
                a += 1
        ...
        if estado_barra.get():
            try:
                ...
                if valor <= 0:
                    ...
                    adicionar_mensagem(label_n.cget("text") + "Variável não pode ser nula ou negativa")
                    a += 1
            except ValueError:
                entry_n.config(bg="red")
                adicionar_mensagem(label_n.cget("text") + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if int(entry_nbq.get()) >= int(entry_n.get()):
                    ...
                    entry_n.config(bg="red")
                    adicionar_mensagem(label_nbq.cget("text") + " maior ou igual ao " + label_n.cget("text"))
                    a += 1
                if valor < 0:
                    entry_nbq.config(bg="red")
                    adicionar_mensagem(label_nbq.cget("text") + "Variável não pode ser negativa")
                    a += 1
            except ValueError:
                entry_nbq.config(bg="red")
                adicionar_mensagem(label_nbq.cget("text") + " ENTRADA INVALIDA!")
                a += 1
            ...
            if entry_nivelbq.get() != options_nivelbq[0] and entry_nivelbq.get() != options_nivelbq[1] and entry_nivelbq.get() != \
                ...
                adicionar_mensagem("Nivel do rompimento das barras não aceito")
                a += 1
        ...
        if estado_mec.get():
            try:
                ...
                if not 0 <= valor <= 100:
                    ...
                    adicionar_mensagem(label_Tfalha.cget("text") + " entrada fora do intervalo permitido (entre 0 e 100%)")
                    a += 1
            except ValueError:
                entry_Tfalha.config(bg="red")
                adicionar_mensagem(label_Tfalha.cget("text") + " ENTRADA INVALIDA!")
                a += 1
    ...
    def selectvar():  #Essa função tem que chamar a simulador, depois
        ...
        jvar = tk.Toplevel(j1)
        jvar.title("Variáveis")

        frame_var = tk.Frame(jvar)
        frame_var.pack()

        label_var = tk.Label(frame_var, text="Selecionar as variáveis que devem ser salvas", font=("Segoe UI", 14, "bold"))
        label_var.grid(row=1, columnspan=2)

        select_V = var
        box_V = tk.Checkbutton(frame_var, text="Tensão de alimentação", variable=select_V, command=manter_marcado)
        box_V.select()
        box_V.grid(row=2, columnspan=2)

        select_Is = var
        box_Is = tk.Checkbutton(frame_var, text="Corrente do estator", variable=select_Is, command=manter_marcado)
        box_Is.grid(row=3, columnspan=2)
        box_Is.select()

        select_Ir = tk.BooleanVar()
        box_Ir = tk.Checkbutton(frame_var, text="Corrente do rotor", variable=select_Ir)
        box_Ir.grid(row=4, columnspan=2)

        select_Fs = tk.BooleanVar()
        box_Fs = tk.Checkbutton(frame_var, text="Fluxo eletromagnético do estator", variable=select_Fs)
        box_Fs.grid(row=5, columnspan=2)

        select_Fr = tk.BooleanVar()
        box_Fr = tk.Checkbutton(frame_var, text="Fluxo eletromagnético do rotor", variable=select_Fr)
        box_Fr.grid(row=6, columnspan=2)

        select_Te = tk.BooleanVar()
        box_Te = tk.Checkbutton(frame_var, text="Torque eletromagnético", variable=select_Te)
        box_Te.grid(row=7, columnspan=2)
        box_Te.select()

        select_vel = tk.BooleanVar()
        box_vel = tk.Checkbutton(frame_var, text="Velocidade do motor", variable=select_vel)
        box_vel.grid(row=8, columnspan=2)
        box_vel.select()

        var_botao = tk.Button(frame_var, text="Selecionar", command=varesc, font=("Segoe UI", 12), width=8)
    ...
    def simulador(var):
        ...
        if nivelbq == "Trinca (10%)":
            nivelbq = 1
        elif nivelbq == "Rachadura (50%)":
            nivelbq = 2
        elif nivelbq == "Quebra (100%)":
            nivelbq = 3
        ...
        if var[5] and var[6]:
            ...
            plt.title("Torque Eletromagnético em função da velocidade")
            plt.ylabel("Torque Eletromagnético (Nm)")
        ...
        if var[4]:
            ...
            plt.title("Fluxo eletromagnético do rotor")
            plt.ylabel("Fluxo")
            plt.xlabel("Tempo (s)")
        ...
        if var[3]:
            ...
            plt.title("Fluxo eletromagnético do estator")
            plt.ylabel("Fluxo")
            plt.xlabel("Tempo (s)")
            plt.legend(["Fase a", "Fase b", "Fase c"])
        ...
        if tp <= 0.75 * tfinal:
            ...
            if aux_fft > 0:
                ...
                plt.xlim(0, 200)
                plt.ylim(-70, 45)
                plt.title("FFT da Corrente da fase a do estator")
        ...
        if var[0]:
            ...
            plt.title("Tensão de alimentação")
            plt.ylabel("Tensão (V)")
            plt.xlabel("Tempo (s)")
            plt.legend(["Fase a", "Fase b", "Fase c"])
        ...
        #header="t,Ias,Ibs,Ics,Iar,Ibr,Icr,Te,Vel,Va,Vb,Vc,If"
        np.savetxt(diretorio + "/" + agora + "_Saída.txt", dados, delimiter=',', header=header)
    ...
    def estimparamcat():
        # ----------------------------------JANELA 2------------------------------#
        j2 = tk.Toplevel(j1)
        j2.title("Estimador de Parâmetros do MIT")
        ...
        label_veln = tk.Label(frame_estim, text="  Velocidade nominal (rpm):")
        ...
        options_cat = {
            "NEMA": ["A", "B", "C", "D"],
            "NBR": ["D", "N", "H"]}
        label_cat = tk.Label(frame_estim, text="Categoria do motor:")
        ...
        label_carga = tk.Label(frame_estim, text="Carga:")
        ...
        label_eff = tk.Label(frame_estim, text="Eficiência (%)")
        ...
        label_fp = tk.Label(frame_estim, text="Fator de Potência")
        ...
        def validarparam():
            ...
            try:
                ...
                if valor<=0:
                    ...
                    adicionar_mensagem(label_Potn.cget("text") + "Variável não pode ser nula ou negativa")
                    a += 1
            except ValueError:
                entry_Potn.config(bg="red")
                adicionar_mensagem(label_Potn.cget("text") + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if valor<=0:
                    ...
                    adicionar_mensagem(label_Vn.cget("text") + "Variável não pode ser nula ou negativa")
                    a += 1
            except ValueError:
                entry_Vn.config(bg="red")
                adicionar_mensagem(label_Vn.cget("text") + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if valor<=0:
                    ...
                    adicionar_mensagem(label_fn.cget("text") + "Variável não pode ser nula ou negativa")
                    a += 1
            except ValueError:
                entry_fn.config(bg="red")
                adicionar_mensagem(label_fn.cget("text") + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if valor<=0:
                    ...
                    adicionar_mensagem(label_Polos.cget("text") + "Variável não pode ser nula ou negativa")
                    a += 1
            except ValueError:
                entry_Polos.config(bg="red")
                adicionar_mensagem(label_Polos.cget("text") + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if valor<=0:
                    ...
                    adicionar_mensagem(label_veln.cget("text") +"Variável não pode ser nula ou negativa")
                    a += 1
            except ValueError:
                entry_veln.config(bg="red")
                adicionar_mensagem(label_veln.cget("text") + " ENTRADA INVALIDA!")
                a += 1

            if entry_norma.get() == '':
                entry_norma.set("ERRO")
                adicionar_mensagem("Norma não selecionada")
                a += 1

            if entry_cat.get() == '':
                entry_cat.set("ERRO")
                adicionar_mensagem("Categoria não selecionada")
                a += 1
            ...
            try:
                ...
                if not (0 <= float(entry_eff_50.get()) <= 100):
                    ...
                    adicionar_mensagem("Eficiência para 50% de carga: fora do intervalo permitido (0 a 100%)")
                    a += 1
            except ValueError:
                entry_eff_50.config(bg="red")
                adicionar_mensagem("Eficiência para 50% de carga: ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if not (0 <= float(entry_eff_75.get()) <= 100):
                    ...
                    adicionar_mensagem("Eficiência para 75% de carga: fora do intervalo permitido (0 a 100%)")
                    a += 1
            except ValueError:
                entry_eff_75.config(bg="red")
                adicionar_mensagem("Eficiência para 75% de carga: ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if not (0 <= float(entry_eff_100.get()) <= 100):
                    ...
                    adicionar_mensagem("Eficiência para 100% de carga: fora do intervalo permitido (0 a 100%)")
                    a += 1
            except ValueError:
                entry_eff_100.config(bg="red")
                adicionar_mensagem("Eficiência para 100% de carga: ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if not (0 <= float(entry_fp_50.get()) <= 1):
                    ...
                    adicionar_mensagem("Fator de potência para 50% de carga: fora do intervalo permitido (0 a 100%)")
                    a += 1
            except ValueError:
                entry_fp_50.config(bg="red")
                adicionar_mensagem("Fator de potência para 50% de carga: ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if not (0 <= float(entry_fp_75.get()) <= 1):
                    ...
                    adicionar_mensagem("Fator de potência para 75% de carga: fora do intervalo permitido (0 a 100%)")
                    a += 1
            except ValueError:
                entry_fp_75.config(bg="red")
                adicionar_mensagem("Fator de potência para 75% de carga: ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if not (0 <= float(entry_fp_100.get()) <= 1):
                    ...
                    adicionar_mensagem("Fator de potência para 100% de carga: fora do intervalo permitido (0 a 100%)")
                    a += 1
            except ValueError:
                entry_fp_100.config(bg="red")
                adicionar_mensagem("Fator de potência para 100% de carga: ENTRADA INVALIDA!")
                a += 1
        ...
        def estimparam():
            ...
            np.savetxt(diretorio + "/" + agora + "_ParamEstim.txt", dados_param, delimiter=',', header=header_param)
            ...
            if estado_graph_estimparam.get():
                ...
                dados_graph[:, 1] = Eff
                dados_graph[:, 2] = FP
                header_graph = "Peixo,Eff,FP"
                np.savetxt(diretorio + "/" + agora + "_Graph_EffFP.txt", dados_graph, delimiter=',', header=header_graph)

                plt.figure(1)
                plt.plot(Peixo, Eff)
                plt.title("Eficiência")
                plt.ylabel("Eficiência (%)")
                plt.xlabel("Potência fornecida em relação à nominal (%)")
                plt.ylim([0, 101])
                plt.xlim([0, 121])
                plt.grid()
                plt.figure(2)
                plt.plot(Peixo, FP)
                plt.title("Fator de Potência")
        ...
        botao_estim = tk.Button(frame_estim, text="ESTIMAR", command=validarparam, font=("Segoe UI", 11))
        botao_estim.grid(row=14, column=1, columnspan=2)

        estado_graph_estimparam = tk.BooleanVar()
        box_graph_estimparam = tk.Checkbutton(frame_estim, text="Mostrar Gráficos", variable=estado_graph_estimparam)
    ...
    def bdcreator():
        ...
        j3.state("zoomed")
        j3.title("Gerador de Banco de Dados")
        ...
        # ----------------------------------Motor------------------------------#
        label_motorsel = tk.Label(frame_bd, text="\n\nSeleção do Motor", font=("Segoe UI", 12,"bold"))
        ...
        botao_motor=tk.Button(frame_bd,text="Selecionar Arquivo", command=selecionar_arquivo)
        botao_motor.grid(row=2,column=1, sticky=tk.W + tk.E)

        label_nsimu=tk.Label(frame_bd,text="  Número de simulações:")
        label_nsimu.grid(row=2,column=2, sticky=tk.W)
        entry_nsimu=tk.Entry(frame_bd)
        entry_nsimu.grid(row=2, column=3, sticky=tk.W + tk.E)

        # ----------------------------------Carga------------------------------#
        label_loadsel = tk.Label(frame_bd, text="Configurações de carga", font=("Segoe UI", 12,"bold"))
        label_loadsel.grid(row=10, columnspan=6, sticky=tk.W)

        label_partbd = tk.Label(frame_bd, text="Tipo de Partida:")
        ...
        options_partbd = ["Sem Carga", "Com Carga"]
        ...
        label_intercarga=tk.Label(frame_bd,text="Intervalo:")
        label_intercarga.grid(row=14, column=0, sticky=tk.W)
        label_mincarga=tk.Label(frame_bd,text="Mínimo")
        label_mincarga.grid(row=14,column=1)
        label_maxcarga = tk.Label(frame_bd, text="Máximo")
        label_maxcarga.grid(row=14, column=2)

        label_pcargabd=tk.Label(frame_bd,text="Carga aplicada (%):")
        ...
        label_jloadbd = tk.Label(frame_bd, text="Momento de inércia (kgm²):")
        ...
        box_desbd = tk.Checkbutton(frame_bd, text="Desequilíbrio de Tensão", font=("Segoe UI", 12, "bold"), variable=estado_desbd)
        ...
        label_interdes = tk.Label(frame_bd, text="Intervalo:")
        label_mindes = tk.Label(frame_bd, text="Mínimo")
        label_maxdes = tk.Label(frame_bd, text="Máximo")

        label_desampbd=tk.Label(frame_bd,text="Percentual de desequilíbrio (%):")
        entry_desampbdmin=tk.Entry(frame_bd)
        entry_desampbdmax = tk.Entry(frame_bd)

        label_desangbd = tk.Label(frame_bd, text="Desequilíbrio angular (%):")
        entry_desangbdmin = tk.Entry(frame_bd)
        entry_desangbdmax = tk.Entry(frame_bd)

        # ----------------------------------Curto------------------------------#
        estado_curtobd = tk.BooleanVar()
        box_curtobd = tk.Checkbutton(frame_bd, text="Curto Circuito nas Espiras do Estator", font=("Segoe UI", 12,"bold"), variable=estado_curtobd)
        ...
        label_intercurto = tk.Label(frame_bd, text="  Intervalo:")
        label_mincurto = tk.Label(frame_bd, text="Mínimo")
        label_maxcurto = tk.Label(frame_bd, text="Máximo")

        label_mibd = tk.Label(frame_bd, text="  Relação de espiras em curto (%):")
        entry_mibdmin = tk.Entry(frame_bd)
        entry_mibdmax = tk.Entry(frame_bd)

        label_rfbd = tk.Label(frame_bd, text="  Multiplicador:")
        ...
        box_barrabd = tk.Checkbutton(frame_bd, text="Barras Quebradas do Rotor", font=("Segoe UI", 12, "bold"),
        ...
        label_nbd = tk.Label(frame_bd, text="Número de barras total:")
        entry_nbd = tk.Entry(frame_bd)

        label_nivelbqbd = tk.Label(frame_bd, text="  Nível da falha:")
        selected_nivelbqbd = tk.StringVar(frame_bd)
        options_nivelbqbd = ["Trinca (10%)", "Rachadura (50%)", "Quebra (100%)"]
        entry_nivelbqbd = ttk.Combobox(frame_bd, values=list(options_nivelbqbd), textvariable=selected_nivelbqbd)

        label_interbarra = tk.Label(frame_bd, text="Intervalo:")
        label_minbarra = tk.Label(frame_bd, text="Mínimo")
        label_maxbarra = tk.Label(frame_bd, text="Máximo")

        label_nbqbd = tk.Label(frame_bd, text="Número de barras quebradas:")
        entry_nbqbdmin = tk.Entry(frame_bd)
        entry_nbqbdmax = tk.Entry(frame_bd)

        # ----------------------------------Falhas Mecânicas------------------------------#
        estado_mecbd = tk.BooleanVar()
        box_mecbd = tk.Checkbutton(frame_bd, text="Falhas Mecânicas", font=("Segoe UI", 12, "bold"), variable=estado_mecbd)
        ...
        label_intermec = tk.Label(frame_bd, text="Intervalo:")
        label_minmec = tk.Label(frame_bd, text="Mínimo")
        label_maxmec = tk.Label(frame_bd, text="Máximo")

        label_Tfalhabd = tk.Label(frame_bd, text="Conjugado da falha (%):")
        ...
        def validarbd():
            ...
            if diretorio_motor=='':
                adicionar_mensagem("Motor não selecionado")
                a+=1
            ...
            try:
                ...
                if valor <= 0:
                    ...
                    adicionar_mensagem(label_nsimu.cget("text")[2:] + "Variável não pode ser nula ou negativa")
                    a += 1
            except ValueError:
                entry_nsimu.config(bg="red")
                adicionar_mensagem(label_nsimu.cget("text")[2:] + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                adicionar_mensagem(label_tpbd.cget("text")[2:] + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if valor <= 0:
                    ...
                    adicionar_mensagem("Ponto mínimo da "+ label_pcargabd.cget("text") + "Variável não pode ser nula ou negativa")
                    a += 1
            except ValueError:
                entry_pcargabdmin.config(bg="red")
                adicionar_mensagem("Ponto mínimo da "+ label_pcargabd.cget("text") + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if valor <= 0:
                    ...
                    adicionar_mensagem("Ponto máximo da "+label_pcargabd.cget("text") + "Variável não pode ser nula ou negativa")
                    a += 1
            except ValueError:
                entry_pcargabdmax.config(bg="red")
                adicionar_mensagem("Ponto máximo da "+label_pcargabd.cget("text") + " ENTRADA INVALIDA!")
                a += 1

            if pmax<pmin:
                entry_pcargabdmin.config(bg="red")
                entry_pcargabdmax.config(bg="red")
                adicionar_mensagem("Ponto máximo do intervalo da carga aplicada maior que o mínimo")
                a+=1
            ...
            try:
                ...
                if valor < 0:
                    ...
                    adicionar_mensagem("Ponto mínimo do "+label_jloadbd.cget("text") +  "Variável não pode ser negativa")
                    a += 1
            except ValueError:
                entry_jloadbdmin.config(bg="red")
                adicionar_mensagem("Ponto mínimo do "+label_jloadbd.cget("text") + " ENTRADA INVALIDA!")
                a += 1
            ...
            try:
                ...
                if valor < 0:
                    entry_pcargabdmax.config(bg="red")
                    adicionar_mensagem("Ponto máximo do "+label_jloadbd.cget("text") + "Variável não pode negativa")
                    a += 1
            except ValueError:
                entry_jloadbdmax.config(bg="red")
                adicionar_mensagem("Ponto máximo do "+label_jloadbd.cget("text") + " ENTRADA INVALIDA!")
                a += 1

            if pmax < pmin:
                entry_jloadbdmin.config(bg="red")
                entry_jloadbdmax.config(bg="red")
                adicionar_mensagem("Ponto máximo do intervalo do momento de inércia da carga maior que o mínimo")
                a += 1
            ...
            if estado_desbd.get():
                try:
                    ...
                    if valor <= 0:
                        ...
                        adicionar_mensagem("Ponto mínimo da " + label_desampbd.cget("text") + "Variável não pode ser nula ou negativa")
                        a += 1
                except ValueError:
                    entry_desampbdmin.config(bg="red")
                    adicionar_mensagem("Ponto mínimo da " + label_desampbd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1
                ...
                try:
                    ...
                    if valor <= 0:
                        ...
                        adicionar_mensagem("Ponto máximo da " + label_desampbd.cget("text") + "Variável não pode ser nula ou negativa")
                        a += 1
                except ValueError:
                    entry_desampbdmax.config(bg="red")
                    adicionar_mensagem("Ponto máximo da " + label_desampbd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1

                if pmax < pmin:
                    entry_desampbdmin.config(bg="red")
                    entry_desampbdmax.config(bg="red")
                    adicionar_mensagem("Ponto máximo da porcentagem de desequilíbrio maior que o mínimo")
                    a += 1
                ...
                try:
                    ...
                    adicionar_mensagem("Ponto mínimo do " + label_desangbd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1
                ...
                try:
                    ...
                    adicionar_mensagem("Ponto máximo do " + label_desangbd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1

                if pmax < pmin:
                    entry_desangbdmin.config(bg="red")
                    entry_desangbdmax.config(bg="red")
                    adicionar_mensagem("Ponto máximo do intervalo da defasagem angular maior que o mínimo")
                    a += 1
            ...
            if estado_curtobd.get():
                try:
                    ...
                    if 0 > valor > 100:
                        ...
                        adicionar_mensagem("Ponto mínimo da " + label_mibd.cget("text") + "Variável fora do intervalo permitido (0 a 100%)")
                        a += 1
                except ValueError:
                    entry_mibdmin.config(bg="red")
                    adicionar_mensagem("Ponto mínimo da " + label_mibd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1
                ...
                try:
                    ...
                    if 0 > valor > 100:
                        ...
                        adicionar_mensagem("Ponto máximo da " + label_mibd.cget("text") + "Variável fora do intervalo permitido (0 a 100%)")
                        a += 1
                except ValueError:
                    entry_mibdmax.config(bg="red")
                    adicionar_mensagem("Ponto máximo da " + label_mibd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1

                if pmax < pmin:
                    entry_mibdmin.config(bg="red")
                    entry_mibdmax.config(bg="red")
                    adicionar_mensagem("Ponto máximo da porcentagem de espiras em curto maior que o mínimo")
                    a += 1
                ...
                try:
                    ...
                    if 0>valor>1:
                        ...
                        adicionar_mensagem("Ponto mínimo do " + label_rfbd.cget("text") + "Variável fora do intervalo permitido (maior que 0)")
                        a += 1
                except ValueError:
                    entry_rfbdmin.config(bg="red")
                    adicionar_mensagem("Ponto mínimo do " + label_rfbd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1
                ...
                try:
                    ...
                    if 0>valor>1:
                        ...
                        adicionar_mensagem("Ponto máximo do " + label_rfbd.cget("text") + "Variável fora do intervalo permitido (maior que 0)")
                        a += 1
                except ValueError:
                    entry_rfbdmax.config(bg="red")
                    adicionar_mensagem("Ponto máximo do " + label_rfbd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1

                if pmax < pmin:
                    entry_rfbdmin.config(bg="red")
                    entry_rfbdmax.config(bg="red")
                    adicionar_mensagem("Ponto máximo do intervalo do multiplicador da resistência de falha maior que o mínimo")
                    a += 1
            ...
            if estado_barrabd.get():
                try:
                    ...
                    if valor <= 0:
                        ...
                        adicionar_mensagem(label_nbd.cget("text") + "Variável não pode ser nula ou negativa")
                        a += 1
                except ValueError:
                    entry_nbd.config(bg="red")
                    adicionar_mensagem(label_nbd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1
                ...
                try:
                    ...
                    if int(entry_nbqbdmin.get()) >= int(entry_nbd.get()):
                        ...
                        entry_nbd.config(bg="red")
                        adicionar_mensagem(label_nbqbd.cget("text") + " maior ou igual ao " + label_nbd.cget("text"))
                        a += 1
                    if valor < 0:
                        entry_nbqbdmin.config(bg="red")
                        adicionar_mensagem("Ponto mínimo do" + label_nbqbd.cget("text") + "Variável não pode ser negativa")
                        a += 1
                except ValueError:
                    entry_nbqbdmin.config(bg="red")
                    adicionar_mensagem("Ponto mínimo do" + label_nbqbd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1
                ...
                try:
                    ...
                    if valor < 0:
                        entry_nbqbdmax.config(bg="red")
                        adicionar_mensagem("Ponto máximo do" + label_nbqbd.cget("text") + "Variável não pode ser negativa")
                        a += 1
                except ValueError:
                    entry_nbqbdmax.config(bg="red")
                    adicionar_mensagem("Ponto máximo do" + label_nbqbd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1
            ...
            if estado_mecbd.get():
                try:
                    ...
                    if not 0 <= valor <= 100:
                        ...
                        adicionar_mensagem(
                            label_Tfalhabd.cget("text") + " entrada fora do intervalo permitido (entre 0 e 100%)")
                        a += 1
                except ValueError:
                    entry_Tfalhabdmin.config(bg="red")
                    adicionar_mensagem(label_Tfalhabd.cget("text") + " ENTRADA INVALIDA!")
                    a += 1
                ...
                if pmin>pmax:
                    ...
                    entry_Tfalhabdmax.config(bg="red")
                    adicionar_mensagem(
                        "Ponto máximo do intervalo do conjugado de falha maior que o mínimo")
                    a += 1
        ...
        def selectvarbd():  # Essa função tem que chamar a simulador, depois
            ...
            label_var = tk.Label(frame_var, text="Selecionar as variáveis que devem ser salvas",
        ...
        def simularbd(var):
            ...
            simu=1
            label_simu=tk.Label(frame_bd,text="Simulações: "+str(simu)+"/"+str(nsimu),font=("Segoe UI", 12))
            label_simu.grid(row=72,columnspan=6)
            header_input="%_carga,J_carga,DeseqAmp,DeseqAng,mi,nrf,Nºbq,T_falha"
            while simu<=nsimu:
                #ENTRADAS ALEATÓRIAS
                ...
                progressobd["value"]=0
                label_simu["text"]="Simulações: "+str(simu)+"/"+str(nsimu)
            progressobd.destroy()
            label_simu.destroy()
            botao_stop.pack_forget()
            botao_play.pack(side=tk.LEFT, padx=10, pady=5)
        ...
        def voltar_princ():
            ...
            j1.deiconify()
            j1.state("zoomed")
        botao_voltar = tk.Button(barra_superiorbd, text="Voltar",font=("Segoe UI", 10), command=voltar_princ, relief=tk.FLAT,
    ...
    menu_arquivo.add_command(label="Abrir",font=("Segoe UI", 10), command=open_data)
    menu_arquivo.add_command(label="Salvar",font=("Segoe UI", 10), command=save_data)
    menu_arquivo.add_separator()
    menu_arquivo.add_command(label="Sair",font=("Segoe UI", 10), command=j1.quit)
    botao_arquivo = tk.Button(barra_superior, text="Arquivo",font=("Segoe UI", 10), relief=tk.FLAT, highlightthickness=0, bd=0)
    botao_arquivo.pack(side=tk.LEFT, padx=10, pady=5)
    botao_arquivo.bind("<Button-1>", abrir_menu_arquivo)
    botao_barraestim = tk.Button(barra_superior, text="Estimador de Parâmetros",font=("Segoe UI", 10), command=estimparamcat, relief=tk.FLAT, highlightthickness=0, bd=0)
    botao_barraestim.pack(side=tk.LEFT, padx=10, pady=5)
    botao_barrabd = tk.Button(barra_superior, text="Banco de Dados",font=("Segoe UI", 10), command=bdcreator, relief=tk.FLAT, highlightthickness=0, bd=0)
...
label_desen=tk.Label(j0, text="Desenvolvido por: Lucas Henrique Gonçalves Ribeiro e Lane Maria Rabelo", font=("Segoe UI",12, "bold"))
